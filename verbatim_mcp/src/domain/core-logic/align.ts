import type { AlignmentResult, ProsodyTrack, ScriptSegment, SegmentAlignment, Transcript } from '../contracts/index.js';
...
export type { AlignmentResult } from '../contracts/index.js';
